...
@Service("superNewSenderInteraction")
public class SuperNewSenderInteraction implements ISenderInteraction {

    private Logger logger = LoggerFactory.getLogger(SuperNewSenderInteraction.class);
